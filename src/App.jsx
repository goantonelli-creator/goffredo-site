...
function AttivitaSvolte() {
  ...
  const attivita = [
    ...
    { azienda: 'Ikonic', settore: 'Fashion retailer', ruolo: 'Consulente organizzativo e controllo di gestione, Mentor, Recruiter' },
    { azienda: "Dell'Oglio 1870", settore: 'Fashion retailer', ruolo: 'Consulente organizzativo e controllo di gestione, Mentor, Recruiter' },
